...
AKAZE_Image_describer_SURF::Regions_ptr AKAZE_Image_describer_SURF::DescribeImpl(
...
AKAZE_Image_describer_LIOP::Regions_ptr AKAZE_Image_describer_LIOP::DescribeImpl(
  const image::Image<unsigned char>& image,
  const image::Image<unsigned char>* mask
)
{
...
AKAZE_Image_describer_MLDB::Regions_ptr AKAZE_Image_describer_MLDB::DescribeImpl(
  const image::Image<unsigned char>& image,
  const image::Image<unsigned char>* mask
)
{
...
)
{
    ...
    {
    case AKAZE_MSURF:
        return std::unique_ptr<AKAZE_Image_describer>(new AKAZE_Image_describer_SURF(params, orientation));
    case AKAZE_LIOP:
        return std::unique_ptr<AKAZE_Image_describer>(new AKAZE_Image_describer_LIOP(params, orientation));
    case AKAZE_MLDB:
        return std::unique_ptr<AKAZE_Image_describer>(new AKAZE_Image_describer_MLDB(params, orientation));
    default:
        return nullptr;
    }
}
